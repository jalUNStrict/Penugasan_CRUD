      ...
      <div className="w-full max-w-2xl rounded-3xl border border-slate-200 bg-white p-10 shadow-sm">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Link href="/register" className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-900 transition-colors hover:bg-slate-50">
              Daftar
            </Link>
          </div>
        </div>
